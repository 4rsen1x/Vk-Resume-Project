...
На рисунке 2.1 представлен интерфейс главной страницы приложения с отображением профиля пользователя и списка созданных резюме.

#figure(
  rect(width: 12cm, height: 8cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для скриншота]*
      
      Рисунок 2.1 — Главная страница приложения
      
      (Скриншот интерфейса Home с профилем VK и списком резюме)
    ]
  ],
...
На рисунке 2.2 показана архитектура системы управления данными с интеграцией Supabase.
  ...
  rect(width: 12cm, height: 8cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для диаграммы]*
      ...
      Рисунок 2.2 — Архитектура управления данными
      
      (Диаграмма: React App ↔ localStorage ↔ Supabase DB)
    ]
  ],
  caption: "Архитектура системы управления данными"
)
...
На рисунке 2.3 показаны все три разработанных шаблона резюме с их характерными особенностями дизайна.

#figure(
  rect(width: 15cm, height: 10cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для скриншота]*
      
      Рисунок 2.3 — Три шаблона резюме
      
      (Сравнение Classic, Modern и Creative шаблонов)
    ]
  ],
  caption: "Разработанные шаблоны резюме"
)
...
На рисунке 2.4 представлен интерфейс редактора резюме с формой заполнения и live preview.
  ...
  rect(width: 15cm, height: 10cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для скриншота]*
      ...
      Рисунок 2.4 — Интерфейс редактора резюме
      
      (Двухколоночный макет: форма редактирования слева, предпросмотр справа)
    ]
  ],
  caption: "Редактор резюме с live preview"
)
...
На рисунке 2.5 показан процесс экспорта резюме в PDF с настройками качества и предварительным просмотром результата.
  ...
  rect(width: 12cm, height: 8cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для скриншота]*
      ...
      Рисунок 2.5 — Процесс экспорта в PDF
      
      (Диалог экспорта с настройками и превью PDF)
    ]
  ],
  caption: "Интерфейс экспорта резюме в PDF"
)
...
На рисунке 2.6 показан интерфейс AI улучшения текста с модальным окном сравнения исходного и улучшенного текста.

#figure(
  rect(width: 12cm, height: 10cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для скриншота]*
      
      Рисунок 2.6 — Интерфейс AI улучшения текста
      
      (Модальное окно с исходным и улучшенным текстом)
    ]
  ],
  caption: "AI функция улучшения текста резюме"
)
...
На рисунке 3.1 представлена общая архитектура разработанного приложения с указанием всех основных компонентов и их взаимодействий.

#figure(
  rect(width: 15cm, height: 10cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для архитектурной диаграммы]*
      
      Рисунок 3.1 — Общая архитектура приложения
      
      (VK Bridge ↔ React App ↔ VKUI ↔ Supabase + OpenRouter)
    ]
  ],
  caption: "Архитектура VK Mini App 'Конструктор резюме'"
)
...
На рисунке 3.2 показаны основные метрики проекта и результаты тестирования приложения.

#figure(
  rect(width: 12cm, height: 8cm, stroke: 1pt + gray)[
    #align(center + horizon)[
      *[Место для графиков и метрик]*
      
      Рисунок 3.2 — Метрики и результаты проекта
      
      (Графики производительности, статистика использования, отзывы пользователей)
    ]
  ],
  caption: "Результаты тестирования и метрики приложения"
)
